...
var _list = require("../../dist/js/list");
            ...
            setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return caller.call(url, _objectSpread(_objectSpread(_objectSpread(_objectSpread({
                      method: method,
                      headers: headers,
                      urlData: urlData,
                      bodyData: bodyData
...
var ApiStoredState = exports.ApiStoredState = function ApiStoredState(caller, url) {
  var _caller$checkStored$d, _caller$checkStored;
  ...
  var getNamespace = function getNamespace(namespace, bodyData) {
    if (!autoNS) {
      ...
      return "".concat(namespace, ":").concat(_list.eList.objToUrlData(bodyData !== null && bodyData !== void 0 ? bodyData : {}));
    }
  };
  var _useState5 = (0, _react.useState)(getNamespace(namespace, bodyData)),
    ...
    getN = _useState6[0],
    setN = _useState6[1];
  var _useState7 = (0, _react.useState)((_caller$checkStored$d = (_caller$checkStored = caller.checkStored(url, getN)) === null || _caller$checkStored === void 0 ? void 0 : _caller$checkStored.data) !== null && _caller$checkStored$d !== void 0 ? _caller$checkStored$d : null),
